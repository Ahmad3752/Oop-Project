...
public class AllStudentsLiving extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(633, 0, 67, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Mobile Number", "Father Name", "Mother name", "Email", "Address", "Department", "Cms", "Room Number"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 690, 370));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/pages background.jpg"))); // NOI18N
